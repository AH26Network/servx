...
read MCVS
	...
	echo screen -h 1024 -dmS $GAMETOINSTALL-$SRVID java -Xmx$RAMM -Xms$RAMM -jar -XX:ParallelGCThreads=1 craftbukkit-$MCVS.jar nogui >> /home/$GAMETOINSTALL-$SRVID/start.sh
